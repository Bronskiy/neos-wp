...
class MY_ACF_PRODUCT_TYPE_PAGE extends MY_ACF {
  // use in acf_add_local_field_group() 
  public $acf_group_key = 'acfconst_' . MY_CPT_PRODUCT_TYPE_PAGE . '_group_key';
  ...
  public $unique_id_prefix = MY_CPT_PRODUCT_TYPE_PAGE;
    ...
    $this->location = array(
      array(
        array(
          'param' => 'post_type',
          'operator' => '==',
          'value' => MY_CPT_PRODUCT_TYPE_PAGE,
        ),
      ),
    );
  }
  ...
  public function register_acf() {
    $this->active_acf_0 = [
      $this->acf_taxonomy([
        'id' => $this->id( 'aa0', 100 ),
        'name' => 'attached_product_type_id',
        'label' => 'Привязанный тип продукта',
        'required' => true,
