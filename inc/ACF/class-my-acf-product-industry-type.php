...
class MY_ACF_PRODUCT_INDUSTRY_TYPE extends MY_ACF {
  // use in acf_add_local_field_group() 
  public $acf_group_key = 'acfconst_' . MY_TAX_PRODUCT_INDUSTRY_TYPE . '_group_key';
  ...
  public $unique_id_prefix = MY_TAX_PRODUCT_INDUSTRY_TYPE;
    ...
    $this->location = array(
      array(
        array(
          'param' => 'taxonomy',
          'operator' => '==',
          'value' => MY_TAX_PRODUCT_INDUSTRY_TYPE,
        ),
      ),
    );
  }
