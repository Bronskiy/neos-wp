...
class MY_ACF_PRODUCT_SINGLE_PAGE_SETTINGS extends MY_ACF {
  public $acf_group_key = 'acfconst_' . 'product_single_page_settings' . '_group_key';
  ...
  public $unique_id_prefix = 'product_single_page_settings';

  public function __construct() {
    $lang_codes = pll_languages_list(); // [ru, en, ...]
    $post_id = get_option( '__single_product_page__settings_id__' );
    $location = [];
